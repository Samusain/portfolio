        ...
        <div className="container hero-content-wrapper">
          ...
          >
            <motion.div variants={itemVariants} className="hero-text">
              <h1>Hi, I'm <span className="gradient-text">Samuel</span></h1>
              <h2>Creative Frontend Developer</h2>
              <p>Crafting immersive digital experiences with cutting-edge technologies and pixel-perfect design.</p>
            </motion.div>
